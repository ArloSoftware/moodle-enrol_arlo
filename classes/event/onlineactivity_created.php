 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class onlineactivity_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('onlineactivitycreated', 'enrol_arlo');
    }
    ...
    public function get_description() {
        return "Updated ARLO OA with GUID '" . $this->other['uid'] . "'.";
    }
    ...
    protected function validate_data() {
        ...
        if (!isset($this->other['activityid'])) {
            throw new \coding_exception('The \'activityid\' value must be set in other.');
        }

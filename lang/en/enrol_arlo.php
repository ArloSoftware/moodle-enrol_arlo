...
$string['maxretires_email_desc'] = 'The email that error reports are sent to when your connection reaches the maximum retries or enrolments fail due to duplicate accounts.';

...
$string['maxretires_email'] = 'Error notifications email';
$string['maxretires_email_desc'] = 'The email that error reports are sent to when your connection reaches the maximum retries. (An user account must exist with this email)';

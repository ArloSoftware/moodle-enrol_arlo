...
$string['privacy:metadata:enrol_arlo_emailqueue:type'] = 'New user or course welecome.';
...
$string['privacy:metadata:enrol_arlo_registration:outcome'] = 'The the outcome (pass/fail) associated with Arlo registration.';
...
$string['emailrandomnumber'] = 'Use full email address + random number';
